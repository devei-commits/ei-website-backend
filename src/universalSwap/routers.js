...
const { getAffected, listHistory, applySwap, saveDraft, finalizeSwap, getHistoryAffected } = require('./controller');
...
router.post('/draft', requireUniversalSwap, saveDraft);
router.post('/:id/finalize', requireUniversalSwap, finalizeSwap);
