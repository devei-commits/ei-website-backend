...
WarehouseInventory.init(
  {
    ...
    wh_stock: { type: DataTypes.DECIMAL(28, 16), allowNull: true, defaultValue: 0 },
    wh_unit: { type: DataTypes.STRING(20), allowNull: true, defaultValue: 'KG' },
    ml1_stock: { type: DataTypes.DECIMAL(28, 16), allowNull: true, defaultValue: 0 },
    ml2_stock: { type: DataTypes.DECIMAL(28, 16), allowNull: true, defaultValue: 0 },
    stock_in_hand: { type: DataTypes.DECIMAL(28, 16), allowNull: true, defaultValue: 0 },
    reserved: { type: DataTypes.DECIMAL(28, 16), allowNull: true, defaultValue: 0 },
    in_transit: { type: DataTypes.DECIMAL(28, 16), allowNull: true, defaultValue: 0 },
