...
const { list, getById, create, update, remove, assignableUsers, generateLabels, savePackLabels, qcReference, nextVendorBatchNo } = require('./controller');
const {
...
router.get('/next-vendor-batch-no', isAuthenticated, nextVendorBatchNo);
...
router.post('/:id/pack-labels', isAuthenticated, savePackLabels);
